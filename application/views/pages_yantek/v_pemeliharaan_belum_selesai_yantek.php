            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                <tr>
                  ...
                  <td>17/08/1945</td>
                  <td>Belum Selesai</td>
                  <td><button><a href="<?php echo site_url('yantek/v_edit_status_pemeliharaan_yantek');?>">Ubah Status</a> </button></td>
                  <td><button><a href="<?php echo site_url('yantek/v_pilih_temuan_pemeliharaan_yantek');?>">Upload Temuan </a> </button></td>
                  <td>           
