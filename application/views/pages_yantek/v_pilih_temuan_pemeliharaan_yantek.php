...
<script type="text/javascript">
  function run() 
  {
    ...
    if (a=='tp') 
    {
      document.getElementById("plhtemuan").href="<?php echo site_url('yantek/v_tambah_pohon_pemeliharaan');?>"; 
    }
    else if (a=='jtm')
    {
      document.getElementById("plhtemuan").href="<?php echo site_url('yantek/v_tambah_jtm_pemeliharaan');?>"; 
    }
    else 
    {
